...
Se hai Windows, ti consigliamo di aggiungere i seguenti percorsi alla variabile d'ambiente di sistema Path (percorso: Sistema -> Impostazioni di sistema avanzate -> Variabili di ambiente -> Variabili di ambiente di sistema -> Selezionare Path e cliccare su Modifica):
C:\_percorso_\anaconda3
C:\_percorso_\anaconda3\Scripts
C.\_percorso_\anaconda3\Library\bin
dove _percorso_ indica la cartella dove si trova anaconda (solitamente è qualcosa come C:\Users\NOMEUTENTE\anaconda3).
